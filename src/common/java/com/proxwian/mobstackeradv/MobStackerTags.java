...
final class MobStackerTags {
    static final String STACK_COUNT = MobStackerAdv.MOD_ID + ":stack_count";
    static final String MANAGED_NAME = MobStackerAdv.MOD_ID + ":managed_name";
    static final String LOVE_COUNT = MobStackerAdv.MOD_ID + ":love_count";
    static final String BREEDING_COOLDOWNS = MobStackerAdv.MOD_ID + ":breeding_cooldowns";
