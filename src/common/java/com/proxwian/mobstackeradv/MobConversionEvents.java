...
public final class MobConversionEvents {
    ...
    public static boolean handlePigLightningConversion(Pig pig, ServerLevel level) {
        ...
        long lockedUntil = MobStackerEntityData.get(pig).getLong(MobStackerTags.PIG_LIGHTNING_CONVERSION_UNTIL);
        ...
        MobStackerEntityData.get(pig).putLong(MobStackerTags.PIG_LIGHTNING_CONVERSION_UNTIL,
    ...
    public static void afterPigLightningConversion(Pig pig, LivingEntity outcome, ServerLevel level) {
        ...
        if (MobStackerEntityData.get(pig).getBoolean(MobStackerTags.MANAGED_NAME)) {
